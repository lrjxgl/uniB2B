<template>
	<view class="main-body">
		...
		<view v-else>
			...
			<view class="order-box">
				<view class="order-box-hd">
					...
					<view @click="gourl('../b2b_order/my')" class="fr cor2 flex flex-center">全部订单
						<text class="iconfont icon-right"></text>
					</view>
				</view>
				<view class="order-box-status flex">
					<view @click="gourl('../b2b_order/my?type=unpay')" class="order-box-item">
						<text class="iconfont icon-moneybag cl-u"></text> 待付款</view>
					<view @click="gourl('../b2b_order/my?type=unpin')" class="order-box-item">
						<text class="iconfont icon-group cl-u"></text> 待成团</view>	
					<view @click="gourl('../b2b_order/my?type=unreceive')" class="order-box-item">
						<text class="iconfont icon-deliver cl-u"></text> 待收货</view>
					<view @click="gourl('../b2b_order/my?type=unraty')" class="order-box-item">
						<text class="iconfont icon-comment cl-u"></text> 待评价</view>
				</view>
			</view>
			 
			<view class="row-box mgb-5">
				<view @click="gourl('/b2b/b2b_coupon_user/index')" class="row-item">
					<view class="row-item-icon icon-ticket  cl-u"></view>
					<view class="row-item-title">优惠券</view>
				</view>
		...
		<b2b-footer tab="user"></b2b-footer>
	</view>
</template>
	...
	export default {
		...
		methods: {
			...
			getPage: function () {
				var that = this;
				that.app.get({
					url: that.app.apiHost + "/b2b_user/index?ajax=1",
					unLogin:true,
